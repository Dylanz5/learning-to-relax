...
def ssor_pcg(
     ...
     x, info = spla.cg(A, b, x0=x0v, rtol=tol, atol=0.0, maxiter=maxiter, M=M)
 
     # SciPy doesn't directly return iteration count; use callback.
     # We rerun with a callback to count cheaply (same cost order as CG itself).
     it = 0
